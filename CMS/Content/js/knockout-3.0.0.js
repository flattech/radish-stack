...
(function() {
    (function(q) {
        ...
        (function(q) { "function" === typeof require && "object" === typeof exports && "object" === typeof module ? q(module.exports || exports) : "function" === typeof define && define.amd ? define(["exports"], q) : q(y.ko = {}); })(function(F) {
            function G(a, c) { return null === a || typeof a in N ? a === c : !1; }
            ...
            a.a = function() {
                function b(a, b) { for (var f in a)a.hasOwnProperty(f) && b(f, a[f]); }
                ...
                b(d, function(a, b) { if (b.length)for (var f = 0, c = b.length; f < c; f++)e[b[f]] = a; });
                ...
                return{
                    ...
                    n: function(a, b) { for (var f = 0, c = a.length; f < c; f++)b(a[f]); },
                    l: function(a, b) {
                    ...
                    wa: function(b) { for (; b.firstChild;)a.removeNode(b.firstChild); },
                    Vb: function(b) {
                        b = a.a.Q(b);
                    ...
                    qb: function(a, b) { 7 > h ? a.setAttribute("selected", b) : a.selected = b; },
                    la: function(a) {
                        return null === a || a ===
                    ...
                    va: function(b) { return a.a.Gb(b, b.ownerDocument.documentElement); },
                    Ra: function(b) { return!!a.a.Ua(b, a.a.va); },
                        ...
                        if (e || "undefined" == typeof u)
                            if (e || "function" != typeof b.addEventListener)
                                if ("undefined" != typeof b.attachEvent) {
                                    var s = function(a) { f.call(b, a); }, l = "on" + d;
                                    b.attachEvent(l, s);
                                    a.a.C.ea(b, function() { b.detachEvent(l, s); });
                    ...
                    c: function(b) { return a.M(b) ? b() : b; },
                    Ha: function(b) { return a.M(b) ? b.t() : b; },
                    ma: function(b, c, f) {
                        if (c) {
                            var d = /\S+/g, e = b.className.match(d) || [];
                            a.a.n(c.match(d), function(b) { a.a.V(e, b, f); });
                            b.className = e.join(" ");
                        }
                    },
                    Ma: function(b, c) {
                    ...
                    Jb: function(a) { 9 <= h && (a = 1 == a.nodeType ? a : a.parentNode, a.style && (a.style.zoom = a.style.zoom)); },
                    Hb: function(a) {
                        if (h) {
                            var b = a.style.width;
                            a.style.width = 0;
                    ...
                    ja: h,
                    ab: function(b, c) {
                        for (var f = a.a.Q(b.getElementsByTagName("input")).concat(a.a.Q(b.getElementsByTagName("textarea"))), d = "string" == typeof c ? function(a) { return a.name === c; } : function(a) { return c.test(a.name); }, e = [], g = f.length - 1; 0 <= g; g--)d(f[g]) && e.push(f[g]);
                        return e;
                    },
                    Wb: function(b) { return"string" == typeof b && (b = a.a.la(b)) ? B && B.parse ? B.parse(b) : (new Function("return " + b))() : null; },
                    Na: function(b, c, f) {
            ...
            a.a.f = new function() {
                ...
                return{
                    ...
                    set: function(c, d, e) { if (e !== q || a(c, !1) !== q)a(c, !0)[d] = e; },
                    clear: function(a) {
                        var b = a[d];
            ...
            (function() {
                a.a.Fa = function(b) {
                    ...
                    if ("undefined" != typeof u)
                        ...
                        d = d.match(/^<(thead|tbody|tfoot)/) && [1, "<table>", "</table>"] || !d.indexOf("<tr") && [
                            2,
            ...
            a.u = function() {
                ...
                return{
                    ...
                    jb: function(a) { return(a = a.match(/^\[ko_memo\:(.*?)\]$/)) ? a[1] : null; }
                };
            }();
            a.b("memoization", a.u);
            ...
            a.ca.fn = {
                T: function(b, c, d) {
                    d = d || I;
                    var e = new a.sb(this, c ? b.bind(c) : b, function() { a.a.ia(this.F[d], e); }.bind(this));
                    this.F[d] || (this.F[d] = []);
                    this.F[d].push(e);
                    return e;
                },
                notifySubscribers: function(b, c) {
                    ...
                    if (this.cb(c))
                        try {
                            a.i.Wa();
                            for (var d = this.F[c].slice(0), e = 0, g; g = d[e]; ++e)
                                g &&
                                    !0 !== g.Qb && g.qa(b);
                        } finally {
                            a.i.end();
                ...
                cb: function(a) { return this.F[a] && this.F[a].length; },
                Lb: function() {
                    var b = 0;
                    a.a.K(this.F, function(a, d) { b += d.length; });
                    return b;
                },
                extend: function(b) {
                    var c = this;
            ...
            a.fb = function(a) { return null != a && "function" == typeof a.T && "function" == typeof a.notifySubscribers; };
            ...
            a.q = function(b) {
                ...
                c.N = function() { c.notifySubscribers(d); };
                c.O = function() { c.notifySubscribers(d, "beforeChange"); };
                a.a.extend(c, a.q.fn);
                a.s(c, "peek", c.t);
            ...
            a.q.fn[C] = a.q;
            a.ya = function(b, c) { return null === b || b === q || b[C] === q ? !1 : b[C] === c ? !0 : a.ya(b[C], c); };
            a.M = function(b) { return a.ya(b, a.q); };
            a.gb = function(b) { return"function" == typeof b && b[C] === a.q || "function" == typeof b && b[C] === a.h && b.Nb ? !0 : !1; };
            a.b("observable", a.q);
            ...
            a.ba.fn = {
                remove: function(b) {
                    for (var c = this.t(), d = [], e = "function" != typeof b || a.M(b) ? function(a) { return a === b; } : b, g = 0; g < c.length; g++) {
                        var h = c[g];
                ...
                destroy: function(b) {
                    var c = this.t(), d = "function" != typeof b || a.M(b) ? function(a) { return a === b; } : b;
                    this.O();
                    for (var e = c.length - 1; 0 <= e; e--)d(c[e]) && (c[e]._destroy = !0);
                    this.N();
                },
                destroyAll: function(b) { return b === q ? this.destroy(function() { return!0; }) : b ? this.destroy(function(c) { return 0 <= a.a.l(b, c); }) : []; },
                indexOf: function(b) {
                    var c = this();
                    return a.a.l(c, b);
                },
            ...
            a.xa.trackArrayChanges = function(b) {
                ...
                if (!b.Xa) {
                    ...
                    b.Xa = function(a, b, c) {
                        function p(a, b, c) { h.push({ status: a, value: b, index: c }); }
            ...
            a.h = function(b, c, d) {
                ...
                function h() {
                    if (!s) {
                        ...
                        s = !0;
                        try {
                            var b = a.a.ha(z, function(a) { return a.target; });
                            a.i.Wa(function(c) {
                                var d;
                ...
                function m() { return!p || 0 < z.length; }
                ...
                v && (l = !0, v.nodeType && (E = function() { return!a.a.va(v) || t && t(); }));
            ...
            a.Pb = function(b) { return a.ya(b, a.h); };
            F = a.q.Yb;
            a.h[F] = a.q;
                    ...
                    na: function(b, c) {
                        ...
                        case "option":
                            ...
                            case "string":
                                ...
                                break;
                            default:
                                a.a.f.set(b, a.d.options.Ea, c), b.__ko__hasDomDataOptionValue__ =
                    ...
                    ka: function(e, f) {
                        function g(b, f) {
                            ...
                            if (r && r.preprocess ? f = r.preprocess(f, b, g) : 1) {
                                if (r = k[b])
                                    e = f, 0 <= a.a.l(c, e) ? e = !1 : (r = e.match(d), e = null === r ? !1 : r[1] ? "Object(" + r[1] + ")" +
                                        r[2] : e), r = e;
                        ...
                        a.a.n(r, function(a) { g(a.key || a.unknown, a.value); });
            ...
            (function() {
                function b(a) { return 8 == a.nodeType && h.test(g ? a.text : a.nodeValue); }

                function c(a) { return 8 == a.nodeType && k.test(g ? a.text : a.nodeValue); }
                ...
                a.e = {
                    ...
                    kb: function(a, c) { b(a) ? a.parentNode.insertBefore(c, a.nextSibling) : a.firstChild ? a.insertBefore(c, a.firstChild) : a.appendChild(c); },
                    eb: function(c, d, e) {
                    ...
                    Mb: b,
                    bc: function(a) { return(a = (g ? a.text : a.nodeValue).match(h)) ? a[1] : null; },
                    ib: function(d) {
                        if (m[a.a.v(d)]) {
                            var k = d.firstChild;
                            if (k) {
            ...
            (function() {
                ...
                function d(b) { return a.a.Da(a.i.p(b), function(a, c) { return function() { return b()[c]; }; }); }

                function e(a,
                    b) { return d(this.getBindings.bind(this, a, b)); }
                ...
                function m(b, d, f, g) {
                    ...
                    var u;
                    if (m) {
                        var w = A ? function(a) { return function() { return c(A()[a]); }; } : function(a) { return m[a]; }, y = function() { return a.a.Da(A ? A() : m, c); };
                        y.get = function(a) { return m[a] && c(w(a)); };
                        y.has = function(a) { return a in m; };
                        g = k(m);
                        a.a.n(g, function(c) {
                            ...
                            try {
                                "function" ==
                                    ...
                                    }), "function" == typeof e && a.h(function() { e(b, w(k), y, f.$data, f); }, null, { I: b });
                            } catch (g) {
                ...
                a.G = function(b, c, d, f) {
                    var e = this,
                        ...
                        h = a.h(function() {
                            ...
                            f && f(e, c, g);
                            return e.$data;
                        }, null, { ua: function() { return g && !a.a.Ra(g); }, I: !0 });
                ...
                a.G.prototype.extend = function(b) { return new a.G(this.$rawData, this, null, function(c) { a.a.extend(c, "function" == typeof b ? b() : b); }); };
                ...
                a.Ta = function(a, b) { 1 !== b.nodeType && 8 !== b.nodeType || g(f(a), b, !0); };
                a.Sa = function(a, b) {
                ...
                a.Cb = function(b) { return(b = a.ta(b)) ? b.$data : q; };
                    ...
                    init: function(b, c, d) {
                        ...
                        if (k || m) {
                            var f = k && a.a.c(c()) instanceof
                                ...
                                s = m || f,
                                l = !1;
                            m && !b.name && a.d.uniqueName.init(b, function() { return!0; });
                            a.h(g, null, { I: b });
                            a.a.r(b, "click", g);
                            a.h(h, null, { I: b });
                            l = !0;
            ...
            a.d.foreach = {
                ...
                init: function(b, c) { return a.d.template.init(b, a.d.foreach.hb(c)); },
                update: function(b, c, d, e, g) { return a.d.template.update(b, a.d.foreach.hb(c), d, e, g); }
            };
            a.g.Y.foreach = !1;
            a.e.P.foreach = !0;
            a.d.hasfocus =
            ...
            a.g.U.hasFocus = !0;
            a.d.html = { init: function() { return{ controlsDescendantBindings: !0 }; }, update: function(b, c) { a.a.Ka(b, c()); } };
            var L = a.a.f.D();
            H("if");
            H("ifnot", !1, !0);
            ...
            a.d.options = {
                ...
                update: function(b,
                    c, d) {
                    function e() { return a.a.ga(b.options, function(a) { return a.selected; }); }
                    ...
                    if (c) {
                        ...
                        var s = a.a.ga(c, function(b) { return m || b === q || null === b || !a.a.c(b._destroy); });
            ...
            a.d.selectedOptions = {
                ...
                init: function(b, c, d) {
                    a.a.r(b, "change", function() {
                        var e = c(), g = [];
                        a.a.n(b.getElementsByTagName("option"), function(b) { b.selected && g.push(a.k.o(b)); });
            ...
            a.d.text = { init: function() { return{ controlsDescendantBindings: !0 }; }, update: function(b, c) { a.a.Ma(b, c()); } };
            a.e.P.text = !0;
            a.d.uniqueName = {
                init: function(b, c) {
                    if (c()) {
            ...
            a.d.value = {
                ...
                init: function(b, c, d) {
                    ...
                    !a.a.ja || "input" != b.tagName.toLowerCase() || "text" != b.type || "off" == b.autocomplete || b.form && "off" == b.form.autocomplete || -1 != a.a.l(g, "propertychange") || (a.a.r(b, "propertychange", function() { k = !0; }), a.a.r(b, "blur", function() { k && e(); }));
                    a.a.n(g, function(c) {
                        var d = e;
                        a.a.ac(c, "after") && (d = function() { setTimeout(e, 0); }, c = c.substring(5));
                        a.a.r(b, c, d);
                    });
                },
                update: function(b, c) {
            ...
            a.w.prototype.isTemplateRewritten = function(a, c) { return!1 === this.allowTemplateRewriting ? !0 : this.makeTemplateSource(a, c).data("isRewritten"); };
            ...
            a.Oa = function() {
                ...
                return{
                    ...
                    Ub: function(a, g) { return a.replace(c, function(a, c, d, f, e) { return b(e, c, d, g); }).replace(d, function(a, c) { return b(c, "\x3c!-- ko --\x3e", "#comment", g); }); },
                    yb: function(b, c) {
            ...
            (function() {
                ...
                function c(c, d) {
                    if (c.length) {
                        ...
                        b(f, e, function(b) { 1 !== b.nodeType && 8 !== b.nodeType || a.Sa(d, b); });
                        b(f, e, function(b) { 1 !== b.nodeType && 8 !== b.nodeType || a.u.vb(b, [d]); });
                        a.a.$(c, g);
                    }
                }
                ...
                a.Ia = function(b, c, f, h, s) {
                    ...
                    if (h) {
                        ...
                        }, null, { ua: function() { return!l || !a.a.va(l); }, I: l && "replaceNode" == s ? l.parentNode : l });
                    }
                    return a.u.Ca(function(d) { a.Ia(b, c, f, d, "replaceNode"); });
                };
                a.$b = function(b, d, f, g, h) {
                    ...
                    function n(a, c) {
                        r = h.createChildContext(a, f.as, function(a) { a.$index = c; });
                        var d = "function" ==
                            typeof b ? b(a, r) : b;
                    ...
                    return a.h(function() {
                        ...
                        b = a.a.ga(b, function(b) { return f.includeDestroyed || b === q || null === b || !a.a.c(b._destroy); });
            ...
            a.a.ra = function() {
                function a(b, d, e, g, h) {
                    ...
                    p = q;
                    for (l = n; p || l;)
                        n = f[p][l] - 1, l && n === f[p][l - 1] ? m.push(k[k.length] = { status: e, value: d[--l], index: l }) : p && n === f[p - 1][l] ? r.push(k[k.length] = {
                            status: g,
                            value: b[--p],
                            index: p
            ...
            (function() {
                function b(b,
                    ...
                    var m = [],
                        f = a.h(function() {
                            ...
                            m.splice(0, m.length);
                            a.a.X(m, f);
                        }, null, { I: b, ua: function() { return!a.a.Ra(m); } });
                ...
                a.a.Ja = function(d, e, g, h, k) {
                    ...
                    function f(b, c) { if (b)for (var d = 0, e = c.length; d < e; d++)c[d] && a.a.n(c[d].R, function(a) { b(a, d, c[d].fa); }); }

                    e = e || [];
                    h = h || {};
                    var p = a.a.f.get(d, c) === q,
                        s = a.a.f.get(d, c) || [],
                        l = a.a.ha(s, function(a) { return a.fa; }),
                        ...
                        w = [];
                    e = [];
                    for (var z = [], l = [], x, A = 0, y, B; y = n[A]; A++)
                        switch (B = y.moved, y.status) {
                        case "deleted":
            ...
            a.J = function() { this.allowTemplateRewriting = !1; };
