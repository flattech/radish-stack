...
{
    public partial class PageHeadBuilder 
    {
        #region Fields
        ...
        public virtual string GenerateTitle(bool addDefaultTitle)
        {
            ...
            if (!String.IsNullOrEmpty(specificTitle))
            {
                ...
                //    switch (AppConfig.Instance.SeoSettings.PageTitleSeoAdjustment)
                //    {
                ...
                //        default:
                //            {
                //                result = string.Join(AppConfig.Instance.SeoSettings.PageTitleSeparator, specificTitle, AppConfig.Instance.SeoSettings.DefaultTitle);
                //            }
                //            break;
