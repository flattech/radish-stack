...
namespace Web.Helpers
{
    public partial class WebHelper 
    {
        ...
        public virtual string GetStoreHost(bool useSsl)
        {
            ...
            if (true)//DataSettingsHelper.DatabaseIsInstalled()
            {
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            //    if (!success)
            //    {
            //        throw new NopException("MentisCMS needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["Mentis.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["Mentis.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["Mentis.IsPOSTBeingDone"] = value;
            }
        }
